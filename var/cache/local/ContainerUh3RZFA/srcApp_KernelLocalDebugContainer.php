 ...
 * @final
 */
class srcApp_KernelLocalDebugContainer extends Container
{
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('KeK1WpMRLW', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DUNk-lY5XE', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        }, 7), true, ($this->targetDir.''.'/srcApp_KernelLocalDebugContainerDeprecations.log'));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9OlqsOBBPu', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CGhQhxkhKg', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getConsole_Command_SecretsDecryptToLocalService()
    {
        ...
        $this->privates['console.command.secrets_decrypt_to_local'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsDecryptToLocalCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault((\dirname(__DIR__, 4).'/config/secrets/local'), $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault((\dirname(__DIR__, 4).'/.env.local.local')))));
    ...
    protected function getConsole_Command_SecretsEncryptFromLocalService()
    {
        ...
        $this->privates['console.command.secrets_encrypt_from_local'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsEncryptFromLocalCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault((\dirname(__DIR__, 4).'/config/secrets/local'), $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault((\dirname(__DIR__, 4).'/.env.local.local')))));
    ...
    protected function getConsole_Command_SecretsGenerateKeyService()
    {
        ...
        $this->privates['console.command.secrets_generate_key'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsGenerateKeysCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault((\dirname(__DIR__, 4).'/config/secrets/local'), $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault((\dirname(__DIR__, 4).'/.env.local.local')))));
    ...
    protected function getConsole_Command_SecretsListService()
    {
        ...
        $this->privates['console.command.secrets_list'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsListCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault((\dirname(__DIR__, 4).'/config/secrets/local'), $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault((\dirname(__DIR__, 4).'/.env.local.local')))));
    ...
    protected function getConsole_Command_SecretsRemoveService()
    {
        ...
        $this->privates['console.command.secrets_remove'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsRemoveCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault((\dirname(__DIR__, 4).'/config/secrets/local'), $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault((\dirname(__DIR__, 4).'/.env.local.local')))));
    ...
    protected function getConsole_Command_SecretsSetService()
    {
        ...
        $this->privates['console.command.secrets_set'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsSetCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault((\dirname(__DIR__, 4).'/config/secrets/local'), $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault((\dirname(__DIR__, 4).'/.env.local.local')))));
    ...
    protected function getContainer_EnvVarProcessorService()
    {
        ...
        return $this->privates['container.env_var_processor'] = new \Symfony\Component\DependencyInjection\EnvVarProcessor($this, new RewindableGenerator(function () {
            yield 0 => ($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault((\dirname(__DIR__, 4).'/config/secrets/local'), $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET'))));
        }, 1));
    }
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDir.''.'/srcApp_KernelLocalDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'srcApp_KernelLocalDebugContainer',
            ...
            'router.cache_class_prefix' => 'srcApp_KernelLocalDebugContainer',
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder638f7 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer8879b = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesc3112 = [
        
    ];

    public function getConnection()
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'getConnection', array(), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'getMetadataFactory', array(), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'getExpressionBuilder', array(), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'beginTransaction', array(), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'getCache', array(), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->getCache();
    }

    public function transactional($func)
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'transactional', array('func' => $func), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->transactional($func);
    }

    public function commit()
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'commit', array(), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->commit();
    }

    public function rollback()
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'rollback', array(), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'getClassMetadata', array('className' => $className), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'createQuery', array('dql' => $dql), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'createNamedQuery', array('name' => $name), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'createQueryBuilder', array(), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'flush', array('entity' => $entity), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'clear', array('entityName' => $entityName), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->clear($entityName);
    }

    public function close()
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'close', array(), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->close();
    }

    public function persist($entity)
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'persist', array('entity' => $entity), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'remove', array('entity' => $entity), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'refresh', array('entity' => $entity), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'detach', array('entity' => $entity), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'merge', array('entity' => $entity), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'getRepository', array('entityName' => $entityName), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'contains', array('entity' => $entity), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'getEventManager', array(), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'getConfiguration', array(), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'isOpen', array(), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'getUnitOfWork', array(), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'getProxyFactory', array(), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'initializeObject', array('obj' => $obj), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'getFilters', array(), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'isFiltersStateClean', array(), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'hasFilters', array(), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return $this->valueHolder638f7->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer8879b = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder638f7) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder638f7 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder638f7->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, '__get', ['name' => $name], $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        if (isset(self::$publicPropertiesc3112[$name])) {
            return $this->valueHolder638f7->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder638f7;
    ...
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;
    ...
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, '__isset', array('name' => $name), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;
    ...
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, '__unset', array('name' => $name), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;
    ...
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, '__clone', array(), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        $this->valueHolder638f7 = clone $this->valueHolder638f7;
    }

    public function __sleep()
    {
        $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, '__sleep', array(), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;

        return array('valueHolder638f7');
    }
    ...
    {
        $this->initializer8879b = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer8879b;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer8879b && ($this->initializer8879b->__invoke($valueHolder638f7, $this, 'initializeProxy', array(), $this->initializer8879b) || 1) && $this->valueHolder638f7 = $valueHolder638f7;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder638f7;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder638f7;
    }
