...
class __TwigTemplate_966aaa6622ff876abe954cd9dd52329c10b7aa1116287cca6d084af6bd2df496 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"metrics\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["transport"]) {
            ...
            echo "</span>
                <span class=\"label\">";
            // line 97
            echo (((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 97, $this->source); })()), "messages", [0 => $context["transport"]], "method", false, false, false, 97)) == 1)) ? ("message") : ("messages"));
            echo "</span>
            </div>
        ";
        }
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/mailer.html.twig", "C:\\Users\\czakaria\\lab\\projects\\soinclair\\soin_clair\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\mailer.html.twig");
    }
}
