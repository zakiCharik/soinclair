...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getSecurity_User_Provider_Concrete_UserProviderService()
    {
        ...
        return $this->privates['security.user.provider.concrete.user_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(($this->services['doctrine'] ?? $this->getDoctrineService()), 'APP\\Entity\\User', 'email', NULL);
    }
